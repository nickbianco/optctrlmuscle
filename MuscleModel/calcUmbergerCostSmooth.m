function heatRates = calcUmbergerCostSmooth(Lce,Vce,F,Fiso,u,a, params)
%-------------------------------------------------------------------------------
% Smooth cost function based on the metabolics probe of Umberger et al. (2003)
% and Umberger (2010). 
%
% USAGE
%   heatRates = calcUmbergerCostSmooth(Lce,Vce,F,Fiso,u,a,params);
%
% INPUTS
...
% Modifications: Nick Bianco, Rachel Troutman, Tom Uchida
%-------------------------------------------------------------------------------

% Check parameters.
% TODO: these may no longer be necessary or even compatible with AdiGator
...
function smoothLogisticFunction
