...
% update datstore or auddata here (whichever gets passed to the muscle
% model)
...
% [degrees, condition, coordinate]
% remove the highest knee flexion and high hip flexion (not in walking)
q_Silder2007{1}(:,4,:) = [];
