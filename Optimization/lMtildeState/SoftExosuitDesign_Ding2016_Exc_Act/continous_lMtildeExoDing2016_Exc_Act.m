function phaseout = continous_lMtildeExoDing2016_Exc_Act(input)
...
[Hilldiff, F] = ForceEquilibrium_lMtildeStateExoDing2016_Exc_Act(a,lMtilde,vMtilde,splinestruct.LMT,params,input.auxdata.Fvparam,input.auxdata.Fpparam,input.auxdata.Faparam);
