function phaseout = continous_lMtildeExoDing2016_MinAlex(input)
...
[Hilldiff, F] = ForceEquilibrium_lMtildeStateExoDing2016_MinAlex(a,lMtilde,vMtilde,splinestruct.LMT,params,input.auxdata.Fvparam,input.auxdata.Fpparam,input.auxdata.Faparam);
